...
//    
//    NSOrderedSet *exercises = [NSOrderedSet orderedSetWithObject:exercise];
...
//        NSLog(@"Name: %@", [workout valueForKey:@"name"]);
////        NSLog(@"Exercise: %@", [workout valueForKey:@"exercise"]);
//    }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WorkoutModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Workout.sqlite"];
